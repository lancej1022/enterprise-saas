// TODO: this is all ztunes logic. Needs to eventually replace or be merged with the solved-contact seed script in /src/db/seed.ts
...
async function seed() {
  const sqlFilePath = join(__dirname, "../src/db/seed.sql.data");
