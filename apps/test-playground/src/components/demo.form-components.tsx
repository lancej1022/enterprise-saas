...
export function TextField({
  ...
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions, @typescript-eslint/no-unsafe-return -- from create-ts-router cli
  const errors = useStore(field.store, (state) => state.meta.errors) as {
    message: string;
  }[];
