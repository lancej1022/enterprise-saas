...
// eslint-disable-next-line max-params -- this is a demo
function fuzzyFilter(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- this is a demo
  row: Row<any>,
  columnId: string,
  value: string,
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- this is a demo
function fuzzySort(rowA: Row<any>, rowB: Row<any>, columnId: string) {
  let dir = 0;

  // Only sort by rank if the column has ranking information
  if (rowA.columnFiltersMeta[columnId]) {
    dir = compareItems(
      // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition -- this is a demo
      rowA.columnFiltersMeta[columnId]?.itemRank,
      // @ts-expect-error -- this is a demo
...
function TableDemo() {
  ...
  function refreshData() {
    return setData((_old) => makeData(50_000));
  } //stress test
  ...
  React.useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/react-compiler -- this is a demo
    // eslint-disable-next-line react-hooks/exhaustive-deps -- this is a demo
